            ...
            <div class="container">
                <ul class="breadcrumbs__list">
                    <li class="breadcrumbs__list-item">
                        <a href=""><span>Головна</span><span>/</span></a>
                    </li>
                    <li class="breadcrumbs__list-item">
                        <a href=""><span>Каталог</span><span>/</span></a>
                    </li>
                    <li class="breadcrumbs__list-item">
                        <a href=""><span>NEOCLIMA</span><span>/</span></a>
                    </li>
                </ul>
            </div>
        </section>
                        ...
                        <div class="product__atribute">
                            ...
                            <div class="panel">
                                <div class="product__atribute-wrapper">
                                    <p class="product__atribute-title">
                                        Номінальна напруга (В-Фаз-Гц):
                                    </p>
                                    <p class="product__atribute-value">220/1/50</p>
                                </div>
                                <div class="product__atribute-wrapper">
                                    <p class="product__atribute-title">
                                        Номінальна споживана потужність(Вт):
                                    </p>
                                    <p class="product__atribute-value">600(52~1550)</p>
                                </div>
                                <div class="product__atribute-wrapper">
                                    <p class="product__atribute-title">
                                        Потужність охолодження (Вт):
                                    </p>
                                    <p class="product__atribute-value">2637(912~4396)</p>
                                </div>
                                <div class="product__atribute-wrapper">
                                    <p class="product__atribute-title">
                                        Потужність обігріву (Вт):
                                    </p>
                                    <p class="product__atribute-value">2857(790~6300)</p>
                                </div>
                            </div>
                        </div>
                        <div class="product__atribute">
                            ...
                            <div class="panel">
                                <div class="product__atribute-wrapper">
                                    <p class="product__atribute-title">SEER (клас):</p>
                                    <p class="product__atribute-value">8,5 (А++)</p>
                                </div>
                                <div class="product__atribute-wrapper">
                                    <p class="product__atribute-title">SCOP:</p>
                                    <p class="product__atribute-value">4,6 (А++)</p>
                                </div>
                            </div>
                        </div>
                        <div class="product__atribute">
                            ...
                            <div class="panel">
                                <div class="product__atribute-wrapper">
                                    <p class="product__atribute-value">R32</p>
                                </div>
                            </div>
                        </div>
                        <div class="product__atribute">
                            ...
                            <div class="panel">
                                <div class="product__atribute-wrapper">
                                    <p class="product__atribute-title">
                                        Розміри внутрішнього блоку (В*Ш*Г), мм:
                                    </p>
                                    <p class="product__atribute-value">802*189*297</p>
                                </div>
                                <div class="product__atribute-wrapper">
                                    <p class="product__atribute-title">Bага, кг:</p>
                                    <p class="product__atribute-value">8,5</p>
                                </div>
                                <div class="product__atribute-wrapper">
                                    <p class="product__atribute-title">Рівень шуму, дБ:</p>
                                    <p class="product__atribute-value">21/25/31/42</p>
                                </div>
                                <div class="product__atribute-wrapper">
                                    <p class="product__atribute-title">
                                        Розмір зовнішнього блоку (Д*В*Г)), мм:
                                    </p>
                                    <p class="product__atribute-value">800*333*554</p>
                                </div>
                                <div class="product__atribute-wrapper">
                                    <p class="product__atribute-title">Bага, кг:</p>
                                    <p class="product__atribute-value">34.7</p>
                                </div>
                                <div class="product__atribute-wrapper">
                                    <p class="product__atribute-title">Розмір труб, мм:</p>
                                    <p class="product__atribute-value">6/9</p>
                                </div>
                            </div>
                        </div>
                        <div class="product__atribute">
                            <div class="accordion">
                                <p>Температурний діапазон</p>
                                <svg
                                        width="24"
                                        height="24"
                                        viewBox="0 0 24 24"
                            ...
                            <div class="panel">
                                <div class="product__atribute-wrapper">
                                    <p class="product__atribute-value">від -25/+54 °C</p>
                                </div>
                            </div>
                        </div>
                        <div class="product__atribute">
                            ...
                            <div class="panel">
                                <div class="product__atribute-wrapper">
                                    <p class="product__atribute-value">24 місяця</p>
                                </div>
                            </div>
                        </div>
                    </aside>
